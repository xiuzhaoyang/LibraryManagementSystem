...
public class Constants {
	...
	public static CheckoutRecord getCheckoutRecord(){
		...
		CheckoutEntry ckEntry4 = new CheckoutEntry(4, 0, LocalDate.of(2015, 5, 10), null, null, false, 0.0f);
		CheckoutEntry ckEntry5 = new CheckoutEntry(5, 0, LocalDate.of(2015, 5, 1), LocalDate.of(2015, 5, 22), null, false, 0.0f);
		CheckoutEntry ckEntry6 = new CheckoutEntry(6, 0, LocalDate.of(2015, 5, 1), LocalDate.of(2015, 5, 22), null, false, 0.0f);
