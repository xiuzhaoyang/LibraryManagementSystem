...
//	private final ObjectProperty<List<PersonRole>> personRoles;
     ...
     * @param lastName
     */
	public LibraryMember(int pid, String firstName, String lastName, String street, String city, String state, String zip, String phoneNum, LocalDate dob, List<PersonRole> personRoles){
